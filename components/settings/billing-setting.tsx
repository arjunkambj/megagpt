...
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("p-2", className)} {...props}>
      ...
      <div className="rounded-large bg-default-100">
        <div className="flex items-center justify-between gap-2 px-4 py-3">
          <div className="flex items-center gap-3">
            <Icon className="h-6 w-6 text-default-500" icon="mdi:credit-card" />
            <div>
          ...
          <Button radius="md" size="sm" variant="shadow">
            Update
          </Button>
        </div>
      </div>
    ...
    <Button className="mt-5" color="primary" size="sm" variant="solid">
      Save
    </Button>
  </div>
));
